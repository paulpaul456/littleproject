...
$sql2= "SELECT `room_sid`, `course_date`, `course_time` FROM `course` WHERE 1";
$stmt2=$pdo->query($sql2);
 while($r=$stmt2->fetch()){
     if($_POST['room_sid']==$r['room_sid'] &&
         $_POST['course_date']==$r['course_date'] &&
         $_POST['course_time']==$r['course_time']) {
